        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div class="pageheader hidden-xs">
                    <h3><i class="fa fa-home"></i> Asignar Tareas</h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Datos para la asignación</h3>
                                </div>
                                          ...
                                          si los datos se actualizan y hacen bien su proceso en el controlador Users y en el respectivo modelo. -->
                                            <?php if ($response == "1") {
                                                echo "<div class=\"alert alert-primary fade in\" role=\"alert\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">
                                                      Se ha asignado correctamente los datos de la tarea
                                                    </div>";
                                            } ?>
                                            ...
                                            <form id="formulario" name="formulario" class="form-horizontal" action="guardarTarea" method="GET" onsubmit="return confirmar()">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        ...
                                                        <option value="">Debora Top</option>
