...
<body>
	<img class="wave" src="<?php echo base_url(); ?>assets/img/waveDos.png">
	<div class="container">
		<div class="img">
			<img src="<?php echo base_url(); ?>assets/img/register.svg">
		</div>
		<div class="login-content">

			<form method="get">

				<img src="<?php echo base_url(); ?>assets/img/LogoApp.png" width="150">
