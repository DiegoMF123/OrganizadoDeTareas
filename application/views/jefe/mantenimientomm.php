                  ...
                  <div class="row">
                   ...
                   <div class="panel">
                       ...
                       <div class="panel-heading">
                           ...
                           <h3 class="panel-title">Listado de solicitudes finalizadas</h3>
                       </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <input type="text" class="form-control" value="<?= $datosolidos->Abreviatura ?> = <?= $datosoli->NombreTipo ?>" readonly>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <input type="text" class="form-control" value="<?= $datosolidos->Abreviaturats ?> = <?= $datosoli->Tiposolicitante ?>" readonly>
                               ...
                               <div class="row">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Listado de solicitudes rechazadas</h3>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <table  class="table table-striped table-bordered">
                                             ...
                                             <tbody align="center">
                                               <?php foreach ($datosolitres as $datosolitres){
                                                 // code...
                                                 ?>
                                                 <tr>
                                                       <!-- Llamado de campos de los datos que queremos mostrar  -->
                                                       <td><?= $datosolitres->idSolicitud ?></td>

                                                       <td><?= $datosolitres->Nosolicitud ?></td>

                                                       <td><?= $datosolitres->NumeroSoporte ?></td>

                                                       <td><?= $datosolitres->Nombre ?></td>

                                                        <td><?= $datosolitres->Fechacreacion ?></td>

                                                        <td><?= $datosolitres->Nit ?></td>

                                                        <td><?= $datosolitres->Abreviatura ?> = <?= $datosolitres->NombreTipo ?></td>

                                                        <td><?= $datosolitres->Abreviaturats ?> = <?= $datosolitres->Tiposolicitante ?></td>

                                                        <td><?= $datosolitres->Nombrestado ?></td>
                                                       ...
                                                       <div class="btn-group dropup">
                                                         <button type="button" class="btn btn-success">
                                                           ...
                                                           <ul class="dropdown-menu">
                                                             ...
                                                             <li>  <a href="" data-toggle="modal" data-target="#myModal4<?= $datosolitres->idSolicitud ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="right" title="Ver información del expediente"><span class="material-icons">folder</span></a></li>

                                                             <li><a href="" data-toggle="modal" data-target="#myModal3<?= $datosolitres->idSolicitud ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="right" title="Ver información del cliente"><span class="material-icons">contact_page</span></a></li>

                                                             <li><a href="" data-toggle="modal" data-target="#myModal<?= $datosolitres->idSolicitud ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="right" title="Ver datos de la solicitud"><span class="material-icons">notes</span></a></li>

                                                             <li>    <a href="" data-toggle="modal" data-target="#myModal2<?= $datosolitres->idSolicitud ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="right" title="Trazabilidad"><span class="material-icons">task</span></a></li>
                                                 ...
                                                 <!-- Modal 1 -->
                                                 <div class="modal fade" id="myModal<?= $datosolitres->idSolicitud ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                       ...
                                                       <div class="modal-content">
                                                         ...
                                                         <div class="modal-header">
                                                           ...
                                                           <h4 class="modal-title" id="myModalLabel">
                                                             ...
                                                             <b>Número de solictud:  <?= $datosolitres->idSolicitud ?></b>
                                                         ...
                                                         <div class="modal-body">
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->Nosolicitud?>" readonly>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <label for=""><b>Descripción</b></label><br>
                                                                       ...
                                                                       <textarea type="text" class="form-control"  readonly><?= $datosolitres->Descripcion ?></textarea>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->Fechacreacion ?>" readonly>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->Abreviatura ?> = <?= $datosolitres->NombreTipo ?>" readonly>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->Abreviaturats ?> = <?= $datosolitres->Tiposolicitante ?>" readonly>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->NumeroSoporte  ?>" readonly>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->Telefono  ?>" readonly>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->Correo  ?>" readonly>
                                                             ...
                                                             <div class="row">
                                                                 ...
                                                                 <div class="col-md-8">
                                                                     ...
                                                                     <input type="text" class="form-control" value="<?= $datosolitres->Nombrestado?>" readonly>
                                                   ...
                                                   <div class="modal fade" id="myModal2<?= $datosolitres->idSolicitud ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                         ...
                                                         <div class="modal-content">
                                                           ...
                                                           <div class="modal-header">
                                                             ...
                                                             <h4 class="modal-title" id="myModalLabel">
                                                               ...
                                                               <b>Estados por lo que la solicitud ha pasado, No de solicitud:  <?= $datosolitres->idSolicitud ?></b>
                                                     ...
                                                     <div class="modal fade" id="myModal3<?= $datosolitres->idSolicitud ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                             ...
                                                             <div class="modal-body">
                                                                 ...
                                                                 <div class="row">
                                                                     ...
                                                                     <div class="col-md-8">
                                                                         ...
                                                                         <input type="text" class="form-control" value="<?= $datosolitres->Nit?>" readonly>
                                                                 ...
                                                                 <div class="row">
                                                                     ...
                                                                     <div class="col-md-8">
                                                                         ...
                                                                         <input type="text" class="form-control" value="<?= $datosolitres->Nombre ?>" readonly>
                                                                 ...
                                                                 <div class="row">
                                                                     ...
                                                                     <div class="col-md-8">
                                                                         ...
                                                                         <input type="text" class="form-control" value="<?= $datosolitres->Direccion ?>" readonly>
                                                       ...
                                                       <div class="modal fade" id="myModal4<?= $datosolitres->idSolicitud ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                               ...
                                                               <div class="modal-body">
                                                                   ...
                                                                   <div class="row">
                                                                       ...
                                                                       <div class="col-md-8">
                                                                           ...
                                                                           <input type="text" class="form-control" value="<?= $datosolitres->Correlativo?>" readonly>
                                                                   ...
                                                                   <div class="row">
                                                                       ...
                                                                       <div class="col-md-8">
                                                                           ...
                                                                           <textarea type="text" class="form-control"  readonly><?= $datosolitres->Observaciones ?></textarea>
