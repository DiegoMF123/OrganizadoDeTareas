                                            ...
                                            <form id="formulario" name="formulario" class="form-horizontal" action="guardardos" method="GET" onsubmit="return confirmar()">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        ...
                                                        <input type="text" class="form-control" name="cofirmarusername" id="cofirmarusername" placeholder="Usuario" required onkeyup="comprobar();" />
                                                        <div id="mensaje"></div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <!--llamamos el Script que esta arriba con un onkeyup para que puedar realizar la validacion del mismo-->
                                                        <input type="password" class="form-control" name="confirmarpassword" id="confirmarpassword" placeholder="Contraseña" required onkeyup="comprobacion();" />
                                                        <div id="mensaje2"></div>
                                                    </div>
                                                </div>
